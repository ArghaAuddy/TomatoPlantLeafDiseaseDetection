...
# -----------------------------
# Load ResNet model and setup
# -----------------------------
model = load_model('../model/tomato_disease_detector.h5')
img_size = (256, 256)  # Adjust based on training if needed
...
# -----------------------------
# Grad-CAM Heatmap for ResNet
# -----------------------------
def get_gradcam_heatmap(model, img_array, last_conv_layer_name='conv5_block3_out', pred_index=None):
...
def display_gradcam(original_img, heatmap, predicted_class, img_name, alpha=0.4):
    ...
    # Save the output
    output_dir = "./gradcam_outputs_resnet"
